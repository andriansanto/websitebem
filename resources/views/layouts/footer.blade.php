<!-- Footer Area Start -->
<footer class="footer-area bg-img bg-overlay-2 section-padding-80-0" style="background-color: #000033;">
    <!-- Main Footer Area -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4" style="padding-top: 20px;">
                    <div class="single-footer-widget mb-60 wow bounceInLeft" style="color: rgba(255, 255, 255, 0.62);">
                        ...
                        <p class="text-left">Jl. Scientia Boulevard, Gading, Serpong, Tangerang, Banten 15227</p>
                    </div>
                </div>
                <!-- Single Footer Widget Area -->
